...
public class ClientCommunicator {
    ...
    /**
     * Connects the client application to the server at the specified IP address and
     * port number.
     * 
    ...
    /**
     * Notifies the server of the client application closing, and closes all
    ...
    /**
     * Creates a search Command to the server and queries for an ArrayList of
     * clients, then returns that list as an Object array to the controller.
     * 
     * @param command The type of search to conduct ("Client ID", "Last Name", or
     *                "Client Type").
    ...
    /**
     * Sends an add Command to the server, and then sends the new client
     * information. Waits for a confirmation Command from the server.
     * 
    ...
    /**
     * Sends a delete Command to the server with the client ID of the client to
     * delete. Waits for a confirmation Command from the server.
     * 
    ...
    /**
     * Sends a modify Command to the server, then sends the updated client
     * information. Waits for a confirmation Command from the server.
     * 
    ...
    /**
     * Receives an serialized ArrayList of Client objects from the server and
     * converts that into an array of Objects.
     * 
